        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" variant="link" onClick={() => window.open("https://play.google.com/store/apps/details?id=com.Eduflage.Chemouflage&hl=en")}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-google-play mr-3 flex-shrink-0" viewBox="0 0 16 16">
                  <path d="M14.222 9.374c1.037-.61 1.037-2.137 0-2.748L11.528 5.04 8.32 8l3.207 2.96zm-3.595 2.116L7.583 8.68 1.03 14.73c.201 1.029 1.36 1.61 2.303 1.055zM1 13.396V2.603L6.846 8zM1.03 1.27l6.553 6.05 3.044-2.81L3.333.215C2.39-.341 1.231.24 1.03 1.27"/>
                </svg>
                <h2 className="text-xl">{slides[currentSlide].cta}</h2>
              </Button>{" "}
              <Button
                variant="outline"
                size="lg"
